    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>DATEC</b>CSIT</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="http://evilnapsis.com/" target="_blank" class="">Ir a Datec</a>
                     </li>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
           ...
           <!-- <li><a href="./?view=sell"><i class='fa fa-usd'></i> <span>Vender</span></a></li>
            ...
            <li class="treeview">
              <a href="#"><i class='fa fa-desktop'></i> <span>Productos</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=products">Todos los Productos</a></li>
                <li><a href="./?view=newinputprod">Insumos</a></li>
                <li><a href="./?view=newequipmentprod">Equipos</a></li>
              </ul>
            </li>

            <li class="treeview">
              <a href="#"><i class='fa fa-book'></i> <span>Catalogos</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=categories">Linea de Negocio</a></li>
                <li><a href="./?view=clients">Clientes</a></li>
                <li><a href="./?view=contac">Contactos</a></li>
                <li><a href="./?view=city">Ciudades</a></li>
                <li><a href="./?view=StateR">Estados de Registro</a></li>
                <li><a href="./?view=StateP">Estados de Producto</a></li>
                <li><a href="./?view=location">Ubicaciones Tecnicas</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=rol">Roles</a></li>
                <li><a href="./?view=function">Funciones y Cargos</a></li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>2018 <a href="http://Datec.com.bo/" target="_blank">Datec</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">DATEC<b>CSIT</b></a>
      </div><!-- /.login-logo -->
