...
<div class="row">
  <div class="col-md-8">
  <h1><?php echo $product->name ?> <small>Editar Producto Insumo</small></h1>
...
<td><div class="row">
  ...
  <br>
    <form class="form-horizontal" method="post" id="addproductI" enctype="multipart/form-data" action="index.php?view=updateproductI" role="form">
...
<?php endif;?>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Numero de Parte*</label>
    <div class="col-md-8">
      <input type="text" name="part_number" class="form-control" id="part_number" value="<?php echo $product->part_number; ?>" placeholder="Numero de Parte">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Estado del Producto</label>
    <div class="col-md-8">
    <select name="estatusP_id" class="form-control">
    <option value="">-- NINGUNA --</option>
    <?php foreach($statusP as $stateP):?>
      <option value="<?php echo $stateP->id;?>" <?php if($product->estatusP_id!=null&& $product->estatusP_id==$stateP->id){ echo "selected";}?>><?php echo $stateP->nameP;?></option>
    <?php endforeach;?>
      </select>    </div>
  </div>
  <div class="form-group">
