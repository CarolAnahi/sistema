...
<div class="row">
	...
	<h1>Nuevo Insumo</h1>
	<br>
		<form class="form-horizontal" method="post" enctype="multipart/form-data" id="addproduct" action="index.php?view=addproductI" role="form">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Numero de Parte*</label>
      <div class="col-md-6">
      <input type="text" name="part_number" id="product_code" class="form-control" id="part_number" placeholder="Part Number">
    </div>
 </div>
